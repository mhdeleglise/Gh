...
public:
  ...
  long64 prev_prime() {return sieve_by_slice<bit_table, long64>::get_previous_prime();}
  long64 next_prime(long64 x) {return sieve_by_slice<bit_table, long64>::get_next_prime(x);}
  long64 prev_prime(long64 x) {return sieve_by_slice<bit_table, long64>::get_previous_prime(x);}
